            ...
            {listLeague.filter(
                ...
                (i) =>  <div className='list__item' key={i.id}>
                            ...
                            <div className='list__item_btns'>
                                <Link to={`/SoccerStatApp/list_leagues/matches/${i.id}`}><button className='list__item_btn btn'>Матчи</button></Link>
                                <Link to={`/SoccerStatApp/list_leagues/teams/${i.id}`}><button className='btn'>Команды</button></Link>
                            </div>
                        </div>
            )}
        </>
